          ...
          child: Container(
            ...
            child: BlocBuilder<TeamSelectionCubit, TeamSelectionState>(
              builder: (context, state) {
                ...
                if(state is TeamSelectionInitial){
                   return Column(
                  children: [
                    Container(
                      height: 200,
                                  ...
                                  if(snapshot.hasData){
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, index){
                                        ...
                                        return SearchResult(
                                          onTap: (){
                                            context.bloc<TeamSelectionCubit>().goToSelectedMember(profile);
                                          }, 
                                          profile: profile
                                        );
                                      }
                  ...
                  final teamSelectionActive = state as TeamSelectionActive;
                  return SelectedTeamMember(
                    profile: teamSelectionActive.profile
                  );
                }
